...
class WriteLogEntriesRequest extends $pb.GeneratedMessage {
  ...
  factory WriteLogEntriesRequest({
    ...
    $core.Iterable<$8.LogEntry>? entries,
  ...
  @$pb.TagNumber(2)
  $5.MonitoredResource get resource => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $5.MonitoredResource ensureResource() => $_ensure(1);

  @$pb.TagNumber(3)
  $core.Map<$core.String, $core.String> get labels => $_getMap(2);

  @$pb.TagNumber(4)
  $core.List<$8.LogEntry> get entries => $_getList(3);
...
class WriteLogEntriesPartialErrors extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, $9.Status> get logEntryErrors => $_getMap(0);
}
...
class ListLogEntriesResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$8.LogEntry> get entries => $_getList(0);
...
class ListMonitoredResourceDescriptorsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.logging.v2'),
      createEmptyInstance: create)
    ..pc<$5.MonitoredResourceDescriptor>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'resourceDescriptors',
        $pb.PbFieldType.PM,
        subBuilder: $5.MonitoredResourceDescriptor.create)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory ListMonitoredResourceDescriptorsResponse({
    $core.Iterable<$5.MonitoredResourceDescriptor>? resourceDescriptors,
    $core.String? nextPageToken,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<$5.MonitoredResourceDescriptor> get resourceDescriptors =>
      $_getList(0);
...
class TailLogEntriesRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $10.Duration get bufferWindow => $_getN(2);
  @$pb.TagNumber(3)
  set bufferWindow($10.Duration v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $10.Duration ensureBufferWindow() => $_ensure(2);
}
