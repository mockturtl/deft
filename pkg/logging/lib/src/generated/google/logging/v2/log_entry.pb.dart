...
import '../type/http_request.pb.dart' as $4;
import '../../api/monitored_resource.pb.dart' as $5;
import '../../protobuf/timestamp.pb.dart' as $6;

import '../type/log_severity.pbenum.dart' as $7;
...
class LogEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.HttpRequest>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'httpRequest',
        subBuilder: $4.HttpRequest.create)
    ..aOM<$5.MonitoredResource>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'resource',
        subBuilder: $5.MonitoredResource.create)
    ..aOM<$6.Timestamp>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..e<$7.LogSeverity>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'severity',
        $pb.PbFieldType.OE,
        defaultOrMaker: $7.LogSeverity.DEFAULT,
        valueOf: $7.LogSeverity.valueOf,
        enumValues: $7.LogSeverity.values)
  ...
  factory LogEntry({
    ...
    $3.Struct? jsonPayload,
    $4.HttpRequest? httpRequest,
    $5.MonitoredResource? resource,
  ...
  @$pb.TagNumber(2)
  $2.Any get protoPayload => $_getN(0);
  @$pb.TagNumber(2)
  set protoPayload($2.Any v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $2.Any ensureProtoPayload() => $_ensure(0);
  ...
  @$pb.TagNumber(6)
  $3.Struct get jsonPayload => $_getN(3);
  @$pb.TagNumber(6)
  set jsonPayload($3.Struct v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $3.Struct ensureJsonPayload() => $_ensure(3);

  @$pb.TagNumber(7)
  $4.HttpRequest get httpRequest => $_getN(4);
  @$pb.TagNumber(7)
  set httpRequest($4.HttpRequest v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $4.HttpRequest ensureHttpRequest() => $_ensure(4);

  @$pb.TagNumber(8)
  $5.MonitoredResource get resource => $_getN(5);
  @$pb.TagNumber(8)
  set resource($5.MonitoredResource v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $5.MonitoredResource ensureResource() => $_ensure(5);

  @$pb.TagNumber(9)
  $6.Timestamp get timestamp => $_getN(6);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $6.Timestamp ensureTimestamp() => $_ensure(6);

  @$pb.TagNumber(10)
  $7.LogSeverity get severity => $_getN(7);
  @$pb.TagNumber(10)
  set severity($7.LogSeverity v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(24)
  $6.Timestamp get receiveTimestamp => $_getN(13);
  @$pb.TagNumber(24)
  set receiveTimestamp($6.Timestamp v) {
    setField(24, v);
  }
  ...
  @$pb.TagNumber(24)
  $6.Timestamp ensureReceiveTimestamp() => $_ensure(13);
