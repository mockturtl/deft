...
import 'package:deft_logging/src/adapters/log_severity.dart' as _i5;
...
class MockLogAdapterBase extends _i1.Mock implements _i2.LogAdapterBase {
  ...
  _i4.Future<void> write({
    ...
    String? requestId,
    Object? error,
    required _i5.LogSeverity? severity,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #write,
