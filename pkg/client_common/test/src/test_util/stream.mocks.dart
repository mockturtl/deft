...
// in deft_client/test/src/test_util/stream.dart.
...
class MockStream<T> extends _i1.Mock implements _i2.Stream<T> {
  ...
  _i2.Future<T> get first => (super.noSuchMethod(
        ...
        returnValue: _i2.Future<T>.value(null),
      ) as _i2.Future<T>);
  @override
  ...
  _i2.Future<S> fold<S>(
    ...
    S Function(
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i2.Future<S>.value(null),
      ) as _i2.Future<S>);
  @override
  ...
  @override
  _i2.Future<dynamic> forEach(void Function(T)? action) => (super.noSuchMethod(
        Invocation.method(
          #forEach,
          [action],
        ),
  ...
  _i2.Future<E> drain<E>([E? futureValue]) => (super.noSuchMethod(
        ...
        returnValue: _i2.Future<E>.value(null),
      ) as _i2.Future<E>);
  @override
